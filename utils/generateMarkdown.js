...
function generateMarkdown(data) {
  ...
  * [Questions](#questions)
  ...
  If you'd like to see more of my projects, check out my github: [${data.github}](https://github.com/${data.github}).
  For further information please contact me at [${data.email}](mailto:${data.email}).
